...
There are also constraints which you can add to modify how your robot follows a path. To understand all of them, navigate to [Constraints](/en/reference/constraints).
To understand how heading interpolation works, navigate to [Interpolation](/en/reference/interpolation).
...
will track the robot's movement throughout the autonomous. Every time the switch changes case, it will reset the timer. The followPath() function sets the follower to run
