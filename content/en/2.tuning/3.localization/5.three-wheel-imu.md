...
::callout{type="warning" title="Note on ESD"}
...
Your robot's IMU might be affected by ESD (electrostatic discharge). Consider grounding the robot with a [grounding strap](https://www.revrobotics.com/rev-31-1269/) and/or [reading this guide from FIRST to understand ESD](https://ftc-docs.firstinspires.org/en/latest/hardware_and_software_configuration/configuring/managing_esd/managing-esd.html)

If after the above you cannot fix the issue, [switch to the non-IMU ThreeWheel Localizer](/en/tuning/localization/three-wheel), as it will be significantly more accurate than an interfered IMU.
::
