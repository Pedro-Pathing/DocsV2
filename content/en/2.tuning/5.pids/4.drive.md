...
Before tuning the Drive PIDF, we will need to set the BrakingStrength. Head over to the [deceleration page](/en/reference/deceleration) to learn more about it.
...
::callout{type="info" title="Tuning Tips"}
...
If you encounter a problem while tuning the Drive PIDF, check out the [troubleshooting page](/en/getting-started/troubleshooting).
